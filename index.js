...
let newBaseName= prompt('new base file name (ie TS22, SM22, OL22, default is TS22) ','TS22');
//ask for filenames
let inputFilePath = prompt('input file CSV (default ts_filenames.csv)? ', 'ts22.csv');
...
let outputFilePath = prompt('output file CSV (default identifiers.csv)? ', 'facultynames.csv');
